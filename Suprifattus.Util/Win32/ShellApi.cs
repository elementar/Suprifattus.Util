...
namespace Suprifattus.Util.Win32
{
	...
	public sealed class ShellApi
	{
		...
		{
			private NativeMethods() { throw new InvalidOperationException(); }
			...
			public struct BROWSEINFO
			{
				...
				private BrowseCallbackProc lpfn;
			...
			public struct SHELLEXECUTEINFO
			{
				...
				private String lpVerb;					// String, referred to as a verb, that specifies the action to 
				// be performed. 
				[MarshalAs(UnmanagedType.LPWStr)]
				private String lpFile;					// Address of a null-terminated string that specifies the name of 
				// the file or object on which ShellExecuteEx will perform the 
				// action specified by the lpVerb parameter.
				[MarshalAs(UnmanagedType.LPWStr)]
				private String lpParameters;				// Address of a null-terminated string that contains the 
				// application parameters.
				[MarshalAs(UnmanagedType.LPWStr)]
				private String lpDirectory;				// Address of a null-terminated string that specifies the name of 
				...
				[MarshalAs(UnmanagedType.LPWStr)]
				private String lpClass;					// Address of a null-terminated string that specifies the name of 
			...
			public struct SHFILEOPSTRUCT
			{
				...
				[MarshalAs(UnmanagedType.LPWStr)]
				private String lpszProgressTitle;		// Address of a string to use as the title of a progress dialog box.
