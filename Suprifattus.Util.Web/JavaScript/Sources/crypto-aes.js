...
function AESEncryptCtr128(plaintext, password) {
  ...
  for (var b=0; b<blockCount; b++) {
    for (c=0; c<8; c++) counterBlock[15-c] = (b >>> c*8) & 0xff;  // set counter in counter block
...
function AESDecryptCtr128(ciphertext, password) {
  ...
  for (b=1; b<ciphertext.length; b++) {
    for (c=0; c<8; c++) counterBlock[15-c] = ((b-1) >>> c*8) & 0xff;  // set counter in counter block
...
}  // include '+' to leave it free for use as a block marker
